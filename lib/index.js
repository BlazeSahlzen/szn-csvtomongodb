...
var onEndParsed = function() {
    ...
    dependency_checker.apply(intermediateQueryInformationTable, [app]);

    query_generator.apply(intermediateQueryInformationTable, []);

    query_executor.apply(intermediateQueryInformationTable, [app]);
 ...
 * @param  {Function} cb    The callback function to call when operation is finished
 */
var csvtomongodb = function(options, cb) {
    ...
    (new csvtojson_wrapper(options.filePath, onRecordParsed, onEndParsed));
